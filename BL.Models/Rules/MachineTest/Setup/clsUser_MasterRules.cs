...
namespace MachineTest.Domain.Rules
{
    ...
    public partial class clsUser_MasterRules : XpertDomainRuleBase<clsUser_Master> 
    {
        protected clsUser_Master _domain;

        public clsUser_MasterRules(clsUser_Master domain)
        {
             _domain = domain;
        }
