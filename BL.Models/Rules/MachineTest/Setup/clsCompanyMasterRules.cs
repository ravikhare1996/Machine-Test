...
namespace MachineTest.Domain.Rules
{
    ...
    public partial class clsCompanyMasterRules : XpertDomainRuleBase<clsCompanyMaster> 
    {
        protected clsCompanyMaster _domain;

        public clsCompanyMasterRules(clsCompanyMaster domain)
        {
             _domain = domain;
        }
