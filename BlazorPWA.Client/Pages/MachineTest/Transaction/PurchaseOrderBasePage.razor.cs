    ...
    public partial class PurchaseOrderBasePage
    {
        ...
        protected async override Task OnInitializedAsync()
        {
            ...
            else
            {
                ...
                POVCodeValue = new FinderData() { Code = Model.POVCode,Name= await getVendorName(Model.POVCode) };
        ...
        private async Task<string?> getVendorName(string VCode)
        {
            string? name= (string?)(await Manager.getSingleValue("select VName from TSPL_VENDOR_MASTER where VCode='" + VCode + "'"));
            return name;
        }
