...
namespace MachineTest.Services.Commands
{
    ...
    public partial class clsUser_MasterUpdateCommand : Command<clsUser_Master>
    {
        protected IclsUser_MasterDataProxy _DataProxy;

        public clsUser_MasterUpdateCommand(clsUser_Master objDomain, IclsUser_MasterDataProxy objDomainDataProxy)
        {
