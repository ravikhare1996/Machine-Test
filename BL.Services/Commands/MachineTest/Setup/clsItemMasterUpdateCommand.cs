...
namespace MachineTest.Services.Commands
{
    ...
    public partial class clsItemMasterUpdateCommand : Command<clsItemMaster>
    {
        protected IclsItemMasterDataProxy _DataProxy;

        public clsItemMasterUpdateCommand(clsItemMaster objDomain, IclsItemMasterDataProxy objDomainDataProxy)
        {
