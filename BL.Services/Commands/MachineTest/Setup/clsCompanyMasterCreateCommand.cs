...
namespace MachineTest.Services.Commands
{
    ...
    public partial class clsCompanyMasterCreateCommand : Command<clsCompanyMaster>
    {
        protected IclsCompanyMasterDataProxy _DataProxy;

        public clsCompanyMasterCreateCommand(clsCompanyMaster objDomain, IclsCompanyMasterDataProxy objDomainDataProxy)
        {
