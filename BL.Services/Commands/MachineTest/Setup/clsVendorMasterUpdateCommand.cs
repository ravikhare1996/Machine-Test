...
namespace MachineTest.Services.Commands
{
    ...
    public partial class clsVendorMasterUpdateCommand : Command<clsVendorMaster>
    {
        protected IclsVendorMasterDataProxy _DataProxy;

        public clsVendorMasterUpdateCommand(clsVendorMaster objDomain, IclsVendorMasterDataProxy objDomainDataProxy)
        {
