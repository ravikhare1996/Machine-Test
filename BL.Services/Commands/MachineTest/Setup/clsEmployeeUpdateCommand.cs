...
namespace MachineTest.Services.Commands
{
    ...
    public partial class clsEmployeeUpdateCommand : Command<clsEmployee>
    {
        protected IclsEmployeeDataProxy _DataProxy;

        public clsEmployeeUpdateCommand(clsEmployee objDomain, IclsEmployeeDataProxy objDomainDataProxy)
        {
