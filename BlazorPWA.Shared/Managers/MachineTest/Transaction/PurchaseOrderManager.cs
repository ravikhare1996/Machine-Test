...
namespace BlazorPWA.Shared.Managers
{
    ...
    public partial class PurchaseOrderManager : CommonManager, IPurchaseOrderManager
    {
        ...
        public async virtual Task<IEnumerable<CustomFinderData>?> GetPOItemListList(clsPurchaseOrderVM entity)
        {
            return await _httpClient.GetFromJsonAsync<IEnumerable<CustomFinderData>>(Routes.PurchaseOrderEndPoints.GetPOItemListList(entity));
        }
    }
}
